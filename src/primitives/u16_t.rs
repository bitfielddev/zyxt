...
fn u16_t() -> BuiltinType {
    ...
    concat(&mut h, Arc::clone(&U16_T));
    unary_unsigned_default::<u16>(&mut h, Arc::clone(&U16_T));
    arith_opr_default::<u16>(&mut h, Arc::clone(&U16_T));
    comp_opr_default::<u16>(&mut h, Arc::clone(&U16_T));
    ...
    type_cast(&mut h, typecast, Arc::clone(&U16_T));
