...
fn u32_t() -> BuiltinType {
    ...
    concat(&mut h, Arc::clone(&U32_T));
    unary_unsigned_default::<u32>(&mut h, Arc::clone(&U32_T));
    arith_opr_default::<u32>(&mut h, Arc::clone(&U32_T));
    comp_opr_default::<u32>(&mut h, Arc::clone(&U32_T));
    ...
    type_cast(&mut h, typecast, Arc::clone(&U32_T));
