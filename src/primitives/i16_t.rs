...
fn i16_t() -> BuiltinType {
    ...
    concat(&mut h, Arc::clone(&I16_T));
    unary_signed_default::<i16>(&mut h, Arc::clone(&I16_T));
    arith_opr_default::<i16>(&mut h, Arc::clone(&I16_T));
    comp_opr_default::<i16>(&mut h, Arc::clone(&I16_T));
    ...
    type_cast(&mut h, typecast, Arc::clone(&I16_T));
