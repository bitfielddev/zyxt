use crate::objects::token::{Flag, Keyword, OprType, Side, TokenCategory, TokenType};
use regex::Regex;
...
pub fn compound_token_entries_2() -> Vec<CompoundTokenEntry<'static>> {
    vec![
        ...
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "if")],
        ...
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "else")],
            ..Default::default()
        },
        CompoundTokenEntry {
            value: "elif",
            type_: TokenType::Keyword(Keyword::Elif),
            combination: &[Pattern::Value(TokenType::Variable, "elif")],
            ..Default::default()
        },
        CompoundTokenEntry {
            value: "do",
            type_: TokenType::Keyword(Keyword::Do),
            combination: &[Pattern::Value(TokenType::Variable, "do")],
            ..Default::default()
        },
        CompoundTokenEntry {
            value: "while",
            type_: TokenType::Keyword(Keyword::While),
            combination: &[Pattern::Value(TokenType::Variable, "while")],
            ..Default::default()
        },
        CompoundTokenEntry {
            value: "for",
            type_: TokenType::Keyword(Keyword::For),
            combination: &[Pattern::Value(TokenType::Variable, "for")],
            ..Default::default()
        },
        CompoundTokenEntry {
            value: "del",
            type_: TokenType::Keyword(Keyword::Delete),
            combination: &[Pattern::Value(TokenType::Variable, "del")],
        ...
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "ret")],
            categories: &[TokenCategory::Literal, TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "proc")],
            categories: &[TokenCategory::Literal, TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "fn")],
            categories: &[TokenCategory::Literal, TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "pre")],
            categories: &[TokenCategory::Literal, TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "class")],
            categories: &[TokenCategory::Literal, TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "struct")],
            categories: &[TokenCategory::Literal, TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "defer")],
            categories: &[TokenCategory::Literal, TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
        ...
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "is")],
            categories: &[TokenCategory::Operator],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "hoi")],
            categories: &[TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "pub")],
            categories: &[TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "priv")],
            categories: &[TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "const")],
            categories: &[TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "inst")],
            categories: &[TokenCategory::ValueStart],
            ..Default::default()
        },
        CompoundTokenEntry {
            ...
            combination: &[Pattern::Value(TokenType::Variable, "true")],
            categories: &[
                TokenCategory::Literal,
                TokenCategory::ValueStart,
                TokenCategory::ValueEnd,
        ...
        CompoundTokenEntry {
            value: "false",
            type_: TokenType::LiteralMisc,
            combination: &[Pattern::Value(TokenType::Variable, "false")],
            categories: &[
                TokenCategory::Literal,
                TokenCategory::ValueStart,
                TokenCategory::ValueEnd,
        ...
        CompoundTokenEntry {
            value: "null",
            type_: TokenType::LiteralMisc,
            combination: &[Pattern::Value(TokenType::Variable, "null")],
            categories: &[
                TokenCategory::Literal,
                TokenCategory::ValueStart,
                TokenCategory::ValueEnd,
        ...
        CompoundTokenEntry {
            value: "inf",
            type_: TokenType::LiteralMisc,
            combination: &[Pattern::Value(TokenType::Variable, "inf")],
            categories: &[
                TokenCategory::Literal,
                TokenCategory::ValueStart,
                TokenCategory::ValueEnd,
        ...
        CompoundTokenEntry {
            value: "undef",
            type_: TokenType::LiteralMisc,
            combination: &[Pattern::Value(TokenType::Variable, "undef")],
            categories: &[
                TokenCategory::Literal,
                TokenCategory::ValueStart,
                TokenCategory::ValueEnd,
